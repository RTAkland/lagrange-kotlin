...
class TeaImpl {
    ...
    private fun decrypt8Bytes(bArr: ByteArray, i2: Int, i3: Int): Boolean {
        this.pos = 0
        while (true) {
            val i4 = this.pos
            if (i4 < 8) {
    ...
    private fun encrypt(bArr: ByteArray, i2: Int, i3: Int, bArr2: ByteArray): ByteArray {
        var i2 = i2
        var i3 = i3
        var i4: Int
    ...
    fun decrypt(bArr: ByteArray, i2: Int, i3: Int, bArr2: ByteArray): ByteArray? {
        var i4 = 0
        this.preCrypt = 0
        this.crypt = 0
        this.key = bArr2
    ...
    fun decrypt(bArr: ByteArray, bArr2: ByteArray): ByteArray {
        return decrypt(bArr, 0, bArr.size, bArr2) ?: throw RuntimeException("decrypt failed")
    }

    fun encrypt(bArr: ByteArray, bArr2: ByteArray): ByteArray {
        return encrypt(bArr, 0, bArr.size, bArr2)
    }
